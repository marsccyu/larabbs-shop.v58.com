            ...
            <ul class="navbar-nav mr-auto">
                ...
                @if(isset($categoryTree))
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="categoryTree">商品分類 <b class="caret"></b></a>
                ...
                @else
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {{--<img src="" class="img-responsive img-circle" width="30px" height="30px" alt="">--}}
                            {{ Auth::user()->name }}
                        </a>
